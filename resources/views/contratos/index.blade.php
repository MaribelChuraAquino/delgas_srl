                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            @if (auth()->user()->tipo == 'administrador')
                                <a class="btn btn-success btn-sm float-right" href="{{ route('contratos.create') }}">Crear Contrato</a>
                            @endif
                        </div>
                                    ...
                                    @foreach ($registros as $reg)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($reg->estado == 'inactivo')
                                                    <span class="badge badge-danger">Inactivo</span>
                                                @endif
                                            </td>
                                            <td>
                                                @if ($reg->documento)
                                                    <a href="{{ asset('storage/' . $reg->documento) }}" target="_blank">Descargar</a>
                                                @else
                                                    No hay documento
                                                @endif
                                            </td>
                                            <td class="project-actions text-left">
                                                <a class="btn btn-info btn-sm" 
                                                    href="{{ route('contratos.show', $reg->id) }}">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                @if (auth()->user()->tipo == 'administrador')
                                                    <a class="btn btn-primary btn-sm"
                                                        href="{{ route('contratos.edit', $reg->id) }}">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <form action="{{ route('contratos.destroy', $reg->id) }}" method="post"
